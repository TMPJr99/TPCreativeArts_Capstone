  ...
  return knex('prints').del()
    .then(function () {
      ...
      return knex('prints').insert([
        ...
        {name: "Abstract Knife unnamed II", genre: 'abstract', series:"none", tier:1, img_location:"images/Abstract Knife unnamed II_low res.jpg"},
        ...
        {name: "Abstract Knife unnamed", genre: 'abstract', series:"none", tier:2,  img_location:"images/Abstract Knife unnamed_low res.jpg"},
        {name: "Aurora", genre: 'landscape', series:"none", tier:2, img_location:"images/Aurora_low res.jpg"},
        {name: "Far Far Away", genre: 'abstract', series:"none", tier:1, img_location:"images/Far Far Away_low res.jpg"},
        ...
        {name: "Resolute", genre: 'impressionist', series:"none", tier:2,  img_location:"images/Resolute_low res.jpg"},
